...
def Phase6Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 1 -------')
...
def Phase6Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 2 -------')
...
#########################################
def Phase6Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 3 -------')
    D1xWR2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no', 'yes', 'no')

def Phase6Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 4 -------')
    D1xKPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no', 'no', 'yes')