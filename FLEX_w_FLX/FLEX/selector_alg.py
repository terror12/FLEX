 ...
 #      print(DSTclosest)
    ...
    if first[-1] > 64000 and first[-1] < 65000 and first[0][1] == first[3][1] and first[7][1] == first[8][1]:
     ...
     #   print(first)
        ...
        set_position_nums2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#        set_position_nums(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
...
#            D3xSet9(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
            ...
            print('START------------------------set3-------------------------')
            Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
    # Bug RB2 runs 4 times (2 loops) instead of running twice when Dnum is 2 drop FLX and RB2 by Dnum
            print('START------------------------set4-------------------------')
            Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
    # Bug FLX runs 4 times (2 loops) instead of running twice when Dnum is 2 drop RB2 and DST by Dnum
            print('START------------------------set5-------------------------')
            Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
    # GOLDEN drop DST and RB by Dnum
            print('START------------------------set6-------------------------')
            Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
    # GOLDEN drop RB and WR by Dnum
            print('START------------------------set7-------------------------')
            Set7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
    # GOLDEN drop WR and QB by Dnum
            print('START------------------------set8-------------------------')
            Set8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
#    return (QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
