def set_position_nums2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST):
    global countQB
    countQB = len(QB)
    global countWR3
    countWR3 = len(WR3)
...
#global count
def D1xWR3PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    global countWR3
    print(Dnum)
    print(len(WR3))
    print(countWR3)
...
def D1xTEPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
...
def D1xWR2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
...
def D1xKPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
...
def D1xRB2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
...
def D1xDSTPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
...
def D1xRBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
...
def D1xWRPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
...
def D1xQBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
...
def Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    print('settt ------- 1 -------')
    D1xWR3PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)
#    D1xTEPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'yes')

def Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    print('settt ------- 2 -------')
    D1xTEPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)
#    count = 0

def Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    print('settt ------- 3 -------')
    D1xWR2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)

def Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    print('settt ------- 4 -------')
    D1xKPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)

def Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    print('settt ------- 5 -------')
    D1xRB2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)

def Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    print('settt ------- 6 -------')
    D1xDSTPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)
def Set7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    print('settt ------- 7 -------')
    D1xRBPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)
def Set8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2, Dnum):
    print('settt ------- 8 -------')
    D1xWRPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)

#    D1xWR2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no')
#    D1xWR2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST)
#    D1xKPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST)
#    D1xRB2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST)
#    D1xDSTPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST)
#    D1xRBPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST)
#    D1xWRPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST)
#    D1xQBPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST)