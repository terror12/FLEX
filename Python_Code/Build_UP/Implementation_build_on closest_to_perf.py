...
def display_closest(spreadsheetId, rangeName):
    ...
    if first[-1] > 64000 and first[-1] < 65000 and first[0][1] == first[3][1] and first[7][1] == first[8][1]:
        ...
        for i in range(32):
            ...
            set_position_nums2('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST)
#
#    # Phase2!!!!!!!!!!
    # Golden drop WR3 and TE by 1
            print('START------------------------set1-------------------------')
            Set1('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)
    # GOLDEN drop TE and WR2 by 1
            print('START------------------------set2-------------------------')
            Set2('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'yes', Dnum)
    # GOLDEN drop WR2 and K by 1
            print('START------------------------set3-------------------------')
            Set3('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'yes', Dnum)
    # GOLDEN drop K and RB2 by 1
            print('START------------------------set4-------------------------')
            Set4('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)
    # GOLDEN drop RB2 and DST by 1
            print('START------------------------set5-------------------------')
            Set5('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'yes', Dnum)
    # GOLDEN drop DST and RB by 1
            print('START------------------------set6-------------------------')
            Set6('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'yes', Dnum)
    # GOLDEN drop RB and WR by 1
            print('START------------------------set7-------------------------')
            Set7('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'yes', 'no', Dnum)
    # GOLDEN drop WR and QB by 1
            print('START------------------------set8-------------------------')
            Set8('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'yes', Dnum)
#
#
#    # Golden drop WR3 and TE by 1
#            print('START------------------------Phase3set1-------------------------')
