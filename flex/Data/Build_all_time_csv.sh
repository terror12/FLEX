#!/bin/bash
# TODO: Generate this without making a new header each time.
...
#2015
pytest -s -v -l --testdata="{'spreadsheetId': '1jAbiqz2hdvXeNnQdmal-k49061uHZM-cbbGbgz3bARs', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1Ww9tL22W4Ug6ahw06gebL0gZ9bY_s2vzA9lnD922byk', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '12ce3MzHTzzLvn5ljznGBO9vfFeiCg-Q-y47PACv_V_w', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '12DTZLcY3RaFRRIMvqthESWJ-W4aRFUyewcJD2Lc8z9U', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1lXfq0tX2-TmI9sPcOzb6vp6n2Lsu6lyK5HooAKRV1Io', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1RyZCElpuwkUk5hMrsC_P7cNevIs3x-lyheEM4XWODj4', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1KGPYAzotY6ZnazSEVv7NRhRTqWSJAfvRpbmLtQ4QHyc', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '199xYEguQqFMLBnkLBnVVyG_apegoNHbY0kSAb6vL8Mg', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1IaV2O7db_hjVc2HWE5uHs_bTko5Ada5CHU-f5nnUF7w', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1ZWdW5KnKe4NFTVc--3beNs_9vduTjQPt3z2PPJQLVsk', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1HBFFYTd1yKMKKt7X_YoR3TlNXJ1hWOnpIJP4ftkpCuA', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1wCY6tZ8suzPBrLwX8bKjJjeXySmWXEqQT6DV2cyOX38', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1nu7gAnek_6kWIY1cmfL7ADt9wxMJglz_My3q3H-mR-Y', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1zNyBafgNGM0UFhV8EW42X-KldpnN-Kwk16sLbOtqirw', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1YPldjf0LLAsgIF7csYEbW-TshvA-taaoAhuCQRYN-XQ', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1r-9h05DZ_rUc-mIxPRXjP44nADVauiOvmRb_3JX6rIg', 'rangeName': 'A1:L1447'}" -m csv_all_data
pytest -s -v -l --testdata="{'spreadsheetId': '1tSiOMZkkBhNEEsedgiU5LxLRdwKg8AL58TWky_hqx6A', 'rangeName': 'A1:L1447'}" -m csv_all_data
