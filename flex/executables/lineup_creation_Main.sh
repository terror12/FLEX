...
do
  pytest -x -s -v -l --testdata="{'spreadsheetId': '18geAFKOD249_p5fKP-J0cfw0glpgH3OnLHJKv00X8qE', 'rangeName': 'A1:L1447', 'QB_std': 2.0, 'RB_std': 1.7, 'WR_std': 2.0, 'TE_std': 0.9, 'DST_std': 2.7, 'FLX_std': $gfstd,  'QB_std2': 1.1, 'RB_std2': 1.5, 'WR_std2': 1.9, 'TE_std2': 1.0, 'DST_std2': 1.0, 'FLX_std2': 1.4, 'min_sal': 58000, 'master_csv': 'future.csv', 'master_csv2': 'future.csv', 'collect_master_csv': 'gold.csv', 'collect_second_csv': 'silver_backup.csv', 'count': '69', 'pairing': False, 'slate': 'SUN-MON'}" -m fd_entry
