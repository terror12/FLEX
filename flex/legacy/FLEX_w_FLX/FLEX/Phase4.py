...
#        print(WR3.head(50))
       ...
       # print(first)
        ...
        if (first[-1] > 50000 and first[-1] < 65000) and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            print('SUCCESS your winning lineup is', first)
        if set1 == 'yes': #count < 1:
            D1xTEPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no', 'yes', 'no')
...
#            print(first)
        if set1 == 'yes': # = Kill
            D1xKPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537',  QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no', 'no', 'no')
        if set2 == 'yes': # = Go
...
def Phase4Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 1 -------')
...
def Phase4Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 2 -------')
    D1xTEPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'yes', 'no', 'no')
#    count = 0

def Phase4Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 3 -------')
    D1xWR2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no', 'yes', 'no')

def Phase4Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 4 -------')
    D1xKPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no', 'no', 'yes')

def Phase4Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 5 -------')
    D1xRB2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no', 'yes', 'no')

def Phase4Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 6 -------')
