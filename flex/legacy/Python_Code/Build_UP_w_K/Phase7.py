    ...
    if (first[-1] > 50000 and first[-1] < 65000) and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
      ...
      #  TE = TE[TE.STD != TEclosest]
        ...
        if (first[-1] > 50000 and first[-1] < 65000) and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            print('SUCCESS your winning lineup is', first)
        if set1 == 'yes':
            D1xRBPLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537',  QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no','no', 'no')
        if set2 == 'yes':
...
def Phase7Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 1 -------')
...
def Phase7Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 2 -------')
...
#########################################
def Phase7Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, K, DST, set1, set2):
    print('settt ------- 3 -------')
    D1xWR2PLEX('1VZLj2gegd6RwDmE3UYprClaGsMe91TDrNw8fsC5ZbD4', 'A1:L537', QB, RB, RB2, WR, WR2, WR3, TE, K, DST, 'no', 'no', 'yes', 'no')
