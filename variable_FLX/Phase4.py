...
def set_position_nums4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std):
    global countQB
    countQB = len(QB)
    global countWR3
    countWR3 = len(WR3)
...
#        print(WR3.head(50))
       ...
       # print(first)
        ...
        if set1 == 'yes': #count < 1:
            D1xTEPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'yes', 'no', Dnum)
...
def D1xDSTPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2,set3,set4, Dnum):
    ...
    if (first[-1] > 50000 and first[-1] < 65000) and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
        ...
        if set4 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum) #, 'no','no', Dnum)
...
def Phase4Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 1 -------')
    D1xWR3PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
#    D1xTEPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

def Phase4Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 2 -------')
    D1xTEPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', 'no', 'no', Dnum)
#    count = 0

def Phase4Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 3 -------')
    D1xWR2PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'yes', 'no', Dnum)

def Phase4Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 4 -------')
    D1xFLXPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no', 'yes', Dnum)

def Phase4Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 5 -------')
    D1xRB2PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'yes', 'no', Dnum)

def Phase4Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 6 -------')
