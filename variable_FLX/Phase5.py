...
def set_position_nums5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std):
    global countQB
    countQB = len(QB)
    global countWR3
    countWR3 = len(WR3)
...
def D1xDSTPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2,set3,set4, Dnum):
    ...
    if (first[-1] > 50000 and first[-1] < 65000) and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
        ...
        if (first[-1] > minSal and first[-1] < 65000): # and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            ...
            D1xDSTPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','no','no', Dnum)
        if set1 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','yes', Dnum)
        if set2 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes','no', Dnum)
        if set3 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no','no', Dnum)
        if set4 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','no', Dnum) #, 'no','no', Dnum)
#            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', Dnum)

def D1xRBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, set3, Dnum):
 ...
 #       print(first)
        if (first[-1] > minSal and first[-1] < 65000): # and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            ...
            D1xRBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','no', Dnum)
        if set1 == 'yes':
            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
        if set2 == 'yes':
            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', Dnum)
        if set3 == 'yes':
            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
#        if set3 == 'yes':
#            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
...
def Phase5Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 1 -------')
...
def Phase5Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 2 -------')
    D1xTEPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no', 'yes', Dnum)
#    count = 0
##########################################
## Step 3 and down need work!!!!
#########################################
def Phase5Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 3 -------')
    D1xWR2PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no', 'yes', Dnum)

def Phase5Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 4 -------')
    D1xFLXPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no', 'yes', Dnum)

def Phase5Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 5 -------')
