...
def set_position_nums6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std):
    global countQB
    countQB = len(QB)
    global countWR3
    countWR3 = len(WR3)
...
def Phase6Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 1 -------')
...
def Phase6Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 2 -------')
...
#########################################
def Phase6Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 3 -------')
    D1xWR2PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'yes', 'no', Dnum)

def Phase6Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 4 -------')
    D1xFLXPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no', 'yes', Dnum)