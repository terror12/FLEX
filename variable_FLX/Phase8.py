...
def set_position_nums8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std):
    global countQB
    countQB = len(QB)
    global countWR3
    countWR3 = len(WR3)
...
#        print(WR3.head(50))
       ...
       # print(first)
        ...
        if (first[-1] > minSal and first[-1] < 65000): # and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            ...
            D1xWR3PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', Dnum)
        if set1 == 'yes': #count < 1:
            D1xTEPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', 'no', 'no', Dnum)
#            D1xWR2PLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', Dnum)

            print(first)
        else:
            print('printing else statement')
            #D1xWR2PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
# could do variation of position, least variiation on top most on bottom
def D1xTEPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, set3, set4, Dnum):
...
#        global count
            ...
            D1xTEPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no','no', Dnum)

        if set1 == 'yes':
            D1xWR2PLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', 'no', 'no', Dnum)
        if set2 == 'yes':
            D1xWR2PLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', 'no', 'no', Dnum)
        if set3 == 'yes':
            D1xWR2PLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'yes' ,'no', Dnum)
        if set4 == 'yes':
            D1xWR2PLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'yes' ,'no', Dnum)
...
def D1xWR2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, set3, set4, Dnum):
...
#            count += 1
#            print(count)
#        D1xFLXPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
#            print(first)
        elif len(WR2) > (countWR2 - Dnum):
            D1xWR2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no','no', Dnum)

        if set1 == 'yes': # = FLXill
            D1xFLXPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', 'no', 'no', Dnum)
        if set2 == 'yes': # = Go
            D1xFLXPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes','no','no', Dnum)
        if set3 == 'yes':
            D1xFLXPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'yes', 'no', Dnum)
        if set4 == 'yes':
            D1xFLXPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no', 'yes', Dnum)
...
def D1xFLXPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, set3, set4, Dnum):
     ...
     #   print(first)
       ...
       # print(first)
        if (first[-1] > minSal and first[-1] < 65000): # and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            ...
            D1xFLXPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no','no', Dnum)

        if set1 == 'yes': #and count <= 2:
            D1xRB2PLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', 'no', 'no', Dnum)
        if set2 == 'yes':
            D1xRB2PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', 'no','no', Dnum)
        if set3 == 'yes':
            D1xRB2PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','yes','no', Dnum)
        if set4 == 'yes':
            D1xRB2PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','no','yes', Dnum)
#            D1xDSTPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', Dnum)

#        if set2 == 'yes':
#            D1xRB2PLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
        #D1xRB2PLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)

def D1xRB2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, set3, set4, Dnum):
    ...
    if (first[-1] > 50000 and first[-1] < 65000) and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
        ...
        if (first[-1] > minSal and first[-1] < 65000): # and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            ...
            D1xRB2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no','no', Dnum)

        if set1 == 'yes':
            D1xDSTPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', 'no', 'no', Dnum)
        if set2 == 'yes':
            D1xDSTPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes','no', 'no', Dnum)
        if set3 == 'yes':
            D1xDSTPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','yes','no', Dnum)
        if set4 == 'yes':
            D1xDSTPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','no','yes', Dnum)
#            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', Dnum)

def D1xDSTPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2,set3,set4, Dnum):
    ...
    if (first[-1] > 50000 and first[-1] < 65000) and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
        ...
        if (first[-1] > minSal and first[-1] < 65000): # and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            ...
            D1xDSTPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no','no', Dnum)

        if set1 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no','no', 'no', Dnum)
        if set2 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes','no','no', Dnum)
        if set3 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','yes','no', Dnum)
        if set4 == 'yes':
            D1xRBPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','no','yes', Dnum) #, 'no','no', Dnum)
#            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', Dnum)

def D1xRBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, set3, set4, Dnum):
 ...
 #       print(first)
        if (first[-1] > minSal and first[-1] < 65000): # and first[0][1] == first[3][1] : #: #and first[7][1] == first[8][1]:
            ...
            D1xRBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no','no', Dnum)

        if set1 == 'yes':
            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no', 'no', Dnum)
        if set2 == 'yes':
            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', 'no', Dnum)
        if set3 == 'yes':
            D1xWRPLEX('spreadsheetId', 'rangeName',  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'no','yes', Dnum)
        if set4 == 'yes':
            D1xWRPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no','no', Dnum)
#        if set3 == 'yes':
...
def D1xWRPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, set3, Dnum):
...
def Phase8Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 1 -------')
    D1xWR3PLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
#    D1xTEPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

def Phase8Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, set1, set2, Dnum):
    print('settt ------- 2 -------')
    D1xTEPLEX('spreadsheetId', 'rangeName', QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', 'no', 'no', Dnum)