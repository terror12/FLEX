...
import time
from D1x_Phase2 import Set1 ## Works!!
...
from D1x_Phase2 import set_position_nums2
...
from Phase3 import set_position_nums3
######
...
from Phase4 import set_position_nums4
######
...
from Phase5 import set_position_nums5
...
#    print(adam)
    ...
    # Create dataframe of just FLEX
    #FLX = adam.loc[adam['position'] == 'RB']
    #FLX.append(adam.loc[adam['position'] == 'WR'])
    #print(adam.loc[adam['position'] == 'WR'])
    #FLX.append(WR)
    #print(FLX)
    #print(FLX.head(10))
    #print(FLX.tail(10))
...
def removeNA(spreadsheetId, rangeName):
    QB, RB, WR, TE, DST = Data_clean(spreadsheetId, rangeName)
#    print(QB)
...
def Roster_cut(spreadsheetId, rangeName):
    QB, RB, WR, TE, DST = removeNA(spreadsheetId, rangeName)
...
def removeLowProjections(spreadsheetId, rangeName):
    QB, RB, WR, TE, DST = Roster_cut(spreadsheetId, rangeName)
#    print(QB)
...
def hitpositionLimits(spreadsheetId, rangeName):
    QB, RB, WR, TE, DST = removeLowProjections(spreadsheetId, rangeName)
...
#    print(WR)
    ...
    QB = QB.sort_values(by=['STD'], ascending=True)
#    print(QB)
...
def useNeededCols(spreadsheetId, rangeName):
    QB, RB, WR, TE, DST = hitpositionLimits(spreadsheetId, rangeName)
#    print(QB)
...
#    FLX.append(TE)
    ...
    FLX = FLX[['player', 'team', 'Actual_Points', 'FanDuel_Salary', 'STD']]
    ...
    FLX['Actual_Points'] = FLX['Actual_Points'].astype('float')
...
#    FLX['FanDuel_Salary'] = FLX['FanDuel_Salary'].astype('float')
...
def order_for_perfect(spreadsheetId, rangeName):
    ...
    QB, RB, WR, TE, FLX, DST = useNeededCols(spreadsheetId, rangeName)
...
#    print(type(FLX))
    ...
    FLX.sort(key=lambda x: x[1], reverse=True)
...
def helper_df_cleanup(spreadsheetId, rangeName):
    QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST = display_closest(spreadsheetId, rangeName)
    ...
    FLX['FanDuel_Salary'] = [s.replace(']],', '') for s in FLX['FanDuel_Salary']]
    FLX['FanDuel_Salary'] = [s.replace('\'', '') for s in FLX['FanDuel_Salary']]
    FLX['FanDuel_Salary'] = [s.replace(']', '') for s in FLX['FanDuel_Salary']]
    FLX['FanDuel_Salary'] = [s.replace(',', '') for s in FLX['FanDuel_Salary']]
    FLX['FanDuel_Salary'] = [float(i) for i in FLX['FanDuel_Salary']]
 ...
 #      print(DSTclosest)
    ...
    if first[-1] > 64000 and first[-1] < 65000 and first[0][1] == first[3][1] and first[7][1] == first[8][1]:
     ...
     #   print(first)
        ...
        FLX_std = 3
        DST_std = 3
        set_position_nums(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std)
        set_position_nums2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std)
        set_position_nums3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std)
        set_position_nums4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std)
        set_position_nums5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std)
        set_position_nums6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std)
        set_position_nums7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std)
        set_position_nums8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, MIN, QB_std, RB_std, RB2_std, WR_std, WR2_std, WR3_std, TE_std, FLX_std, DST_std)
#        set_position_nums(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
## GOLDEN Drop each position seperatley by just 1
#        D1x(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
#
# Phase2!!!!!!!!!!
# Golden drop WR3 and TE by 1
#        print('START------------------------set1-------------------------')
#        Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
## GOLDEN drop TE and WR2 by 1
#        print('START------------------------set2-------------------------')
#        Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
## GOLDEN drop WR2 and FLX by 1
#        print('START------------------------set3-------------------------')
#        Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
## GOLDEN drop FLX and RB2 by 1
#        print('START------------------------set4-------------------------')
#        Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
## GOLDEN drop RB2 and DST by 1
#        print('START------------------------set5-------------------------')
#        Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
## GOLDEN drop DST and RB by 1
#        print('START------------------------set6-------------------------')
#        Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
## GOLDEN drop RB and WR by 1
#        print('START------------------------set7-------------------------')
#        Set7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
## GOLDEN drop WR and QB by 1
#        print('START------------------------set8-------------------------')
#        Set8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#
## Golden drop WR3 and TE by 1
#        print('START------------------------Phase3set1-------------------------')
#        Phase3Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
## GOLDEN drop TE and WR2 by 1
#        print('START------------------------Phase3set2-------------------------')
#        Phase3Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
## GOLDEN drop WR2 and FLX by 1
#        print('START------------------------Phase3set3-------------------------')
#        Phase3Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
## GOLDEN drop FLX and RB2 by 1
#        print('START------------------------Phase3set4-------------------------')
#        Phase3Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
## GOLDEN drop RB2 and DST by 1
#        print('START------------------------Phase3set5-------------------------')
#        Phase3Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
## GOLDEN drop DST and RB by 1
#        print('START------------------------Phase3set6-------------------------')
#        Phase3Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
## GOLDEN drop RB and WR by 1
#        print('START------------------------Phase3set7-------------------------')
#        Phase3Set7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
##______________________________________________________________________
#
#        print('START------------------------Phase4set1-------------------------')
#        Phase4Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
#
#        print('START------------------------Phase4set2-------------------------')
#        Phase4Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#        print('START------------------------Phase4set3-------------------------')
#        Phase4Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#        print('START------------------------Phase4set4-------------------------')
#        Phase4Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
#
#        print('START------------------------Phase4set5-------------------------')
#        Phase4Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#        print('START------------------------Phase4set6-------------------------')
#        Phase4Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#     # ______________________________________________________________________
#
#        print('START------------------------Phase5set1-------------------------')
#        Phase5Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes','no')
#
#        print('START------------------------Phase5set2-------------------------')
#        Phase5Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#        print('START------------------------Phase5set3-------------------------')
#        Phase5Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#        print('START------------------------Phase5set4-------------------------')
#        Phase5Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
#
#        print('START------------------------Phase5set5-------------------------')
#        Phase5Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#     # ______________________________________________________________________
#
#        print('START------------------------Phase6set1-------------------------')
#        Phase6Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
#
#        print('START------------------------Phase6set2-------------------------')
#        Phase6Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#        print('START------------------------Phase6set3-------------------------')
#        Phase6Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#        print('START------------------------Phase6set4-------------------------')
#        Phase6Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
#
#     # ______________________________________________________________________
#        print('START------------------------Phase7set1-------------------------')
#        Phase7Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
#
#        print('START------------------------Phase7set2-------------------------')
#        Phase7Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#
#        print('START------------------------Phase7set3-------------------------')
#        Phase7Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#        print('START------------------------Phase8set1-------------------------')
#        Phase8Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no')
#
#        print('START------------------------Phase8set2-------------------------')
#        Phase8Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes')
#    #### GOLDEN!!!!!!!!!!!!!!!!
#
## Drop each position individually by 2
#        print('START------------------------D2X-------------------------')
#        D2x(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
...
# Removes each position individually starting from removing just 1 player to removing 31 players.
        for i in range(32):
            ...
            Dnum = i
            print('START------------------------D3xSet1-------------------------')
            D3xSet1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
            print('START------------------------D3xSet2-------------------------')
            D3xSet2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
            print('START------------------------D3xSet3-------------------------')
            # Bug in WR2 it removes 3 on first go when it should only remove 1. RFE it!
            # Bug 2 in WR2 it only runs three times always even when the number rises
            # to 4 and 5 and so on. Revisit!!!!!
            D3xSet3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
            print('START------------------------D3xSet4-------------------------')
            D3xSet4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
            print('START------------------------D3xSet5-------------------------')
            D3xSet5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
            print('START------------------------D3xSet6-------------------------')
            D3xSet6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
            print('START------------------------D3xSet7-------------------------')
            D3xSet7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
            print('START------------------------D3xSet8-------------------------')
            D3xSet8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
            print('START------------------------D3xSet8-------------------------')
            D3xSet9(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------set1-------------------------')
            Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'yes', Dnum)
            print('START------------------------set2-------------------------')
            Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'yes', Dnum)
            print('START------------------------set3-------------------------')
            Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'yes', Dnum)
    # Bug RB2 runs 4 times (2 loops) instead of running twice when Dnum is 2 drop FLX and RB2 by Dnum
            print('START------------------------set4-------------------------')
            Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'yes', Dnum)
    # Bug FLX runs 4 times (2 loops) instead of running twice when Dnum is 2 drop RB2 and DST by Dnum
            print('START------------------------set5-------------------------')
            Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'yes', Dnum)
    # Bug FLX runs 4 times (2 loops) instead of running twice
    # GOLDEN drop DST and RB by Dnum
            print('START------------------------set6-------------------------')
            Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'yes', Dnum)
    # Bug FLX runs 4 times (2 loops) instead of running twice
    # GOLDEN drop RB and WR by Dnum
            print('START------------------------set7-------------------------')
            Set7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'yes', Dnum)
    # Bug FLX runs 4 times (2 loops) instead of running twice
    # GOLDEN drop WR and QB by Dnum
            print('START------------------------set8-------------------------')
            Set8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'yes', Dnum)
    #GOOOD____________________________________________________________________________________________________________
            #_________________________________________________________________________
            #_________________________________________________________________________
    # Golden drop WR3 and TE by 1
            print('START------------------------Phase3set1-------------------------')
            Phase3Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
    # GOLDEN drop TE and WR2 by 1
            print('START------------------------Phase3set2-------------------------')
            Phase3Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
    # GOLDEN drop WR2 and FLX by 1
            print('START------------------------Phase3set3-------------------------')
            Phase3Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
    # GOLDEN drop FLX and RB2 by 1
            print('START------------------------Phase3set4-------------------------')
            Phase3Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
    # GOLDEN drop RB2 and DST by 1
            print('START------------------------Phase3set5-------------------------')
            Phase3Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
    # GOLDEN drop DST and RB by 1
            print('START------------------------Phase3set6-------------------------')
            Phase3Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
    # GOLDEN drop RB and WR by 1
            print('START------------------------Phase3set7-------------------------')
            Phase3Set7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
    #________________
    # GOOOOD__________________________________________________________
    #_________________________________________________________________
    #_________________________________________________________________
            print('START------------------------Phase4set1-------------------------')
            Phase4Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)

            print('START------------------------Phase4set2-------------------------')
            Phase4Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase4set3-------------------------')
            Phase4Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase4set4-------------------------')
            Phase4Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)

            print('START------------------------Phase4set5-------------------------')
            Phase4Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase4set6-------------------------')
            Phase4Set6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
     #GOOOODD!!!______________________________________________________
     #GOOOODD!!!______________________________________________________
     #GOOOODD!!!______________________________________________________
            print('START------------------------Phase5set1-------------------------')
            Phase5Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes','no', Dnum)

            print('START------------------------Phase5set2-------------------------')
            Phase5Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase5set3-------------------------')
            Phase5Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase5set4-------------------------')
            Phase5Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)

            print('START------------------------Phase5set5-------------------------')
            Phase5Set5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)
    #GGOOOOD____________________________________________________________
    #GGOOOOD____________________________________________________________
    #GGOOOOD____________________________________________________________
            print('START------------------------Phase6set1-------------------------')
            Phase6Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)

            print('START------------------------Phase6set2-------------------------')
            Phase6Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase6set3-------------------------')
            Phase6Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase6set4-------------------------')
            Phase6Set4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)
            print('START------------------------Phase7set1-------------------------')
            Phase7Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)

            print('START------------------------Phase7set2-------------------------')
            Phase7Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase7set3-------------------------')
            Phase7Set3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

            print('START------------------------Phase8set1-------------------------')
            Phase8Set1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'yes', 'no', Dnum)

            print('START------------------------Phase8set2-------------------------')
            Phase8Set2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST, 'no', 'yes', Dnum)

#
#
#
#   Selector Algorthim Complete!!
#
#
#
...
# def display_closest2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#         display_closest2(spreadsheetId, rangeName,  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
#   #      print(first)

#def WR3PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#    QBSTD = QB['STD']
#
#    QBSTD = QBSTD.values.tolist()
#    QB_avg_std = 1.7697010980470589
...
#
#def TEPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
...
#
#def WR2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#    QBSTD = QB['STD']
#
#    QBSTD = QBSTD.values.tolist()
...
#
#def FLXPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#    QBSTD = QB['STD']
#
#    QBSTD = QBSTD.values.tolist()
...
#     #   print(first)
#        print('_________________________________________________')
#        print('FLXPLEX PRINT OUT BEFORE')
#        print('WR3')
#        print(len(WR3))
#        print('TE')
#        print(len(TE))
...
#
#def RB2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#    QBSTD = QB['STD']
#
#    QBSTD = QBSTD.values.tolist()
...
#
# def DSTPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#
# def RBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#
# def WRPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#
# def QBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#
#
# def WR3PLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
#     QB_avg_std = 1.7697010980470589
...
# def TEPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#  #   WR = display_closest(spreadsheetId, rangeName)
#
#     QBSTD = QB['STD']
#
...
#         #        WR2PLEX(spreadsheetId, rangeName,  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def WR2PLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#  #       FLXPLEX(spreadsheetId, rangeName,  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def FLXPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#      #       RB2PLEX(spreadsheetId, rangeName,  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def RB2PLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
# #        DSTPLEX(spreadsheetId, rangeName,  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def DSTPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#  #       RBPLEX(spreadsheetId, rangeName,  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def RBPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
#  #       WRPLEX(spreadsheetId, rangeName,  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def WRPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
# #        QBPLEX(spreadsheetId, rangeName,  QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def QBPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     QBSTD = QB['STD']
#
#     QBSTD = QBSTD.values.tolist()
...
# def Phase1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     WR3PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
#
# def Phase1x(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     WR3PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     WR3PLEXcontd(spreadsheetId, rangeName)
#
# def Phase2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     TEPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def Phase3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     WR2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def Phase4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     FLXPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def Phase5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     RB2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def Phase6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     DSTPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def Phase7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     RBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def Phase8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     WRPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def Phase9(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     QBPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def PhaseX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#
#     WR3PLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
...
# def D1x(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     Phase1(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     Phase2(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     Phase3(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     Phase4(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     Phase5(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     Phase6(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     Phase7(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     Phase8(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     Phase9(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#
# def D2x(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST):
#     WR3PLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     TEPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     WR2PLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     FLXPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     RB2PLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     DSTPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     RBPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     WRPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#     QBPLEXX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#    for i in range(2):
#        TEPLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
#    for i in range(2):
#        WR2PLEX(spreadsheetId, rangeName, QB, RB, RB2, WR, WR2, WR3, TE, FLX, DST)
